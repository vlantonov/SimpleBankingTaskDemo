...
4. **No `fastapi`, `httpx`, or `sqlalchemy` imports in usecase tests** — the layer is framework-free. If a test imports any of these, the dependency leaked into the usecase or its fakes.
